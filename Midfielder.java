...
public class Midfielder extends Player {
    ...
    public String toString(){
        return String.format("Player Name='%s, JerseyNumber=%d Position (%s) Midfielder SPEED=%.1f, STAMINA=%.1f, PASSING=%.1f\n",
                super.getName(), super.getJerseyNumber(), super.getPosition(), super.getSpeed(), super.getStamina(), getPassing());
    }
}
